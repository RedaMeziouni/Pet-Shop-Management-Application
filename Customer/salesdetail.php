...
<body>
    ...
    <!-- end navbar -->
    <!-- <a>Add New Details</a> -->
    <button class="add" id="open">Add New Details</button>
    <button class="add">Update Details</button>
    <button class="add">Sold products</button>
    ...
    <table class="z-table">
        <thead>
            ...
            <th class="z-th">cs_id</th>
            <th class="z-th">date</th>
            <th class="z-th">quantity</th>
        </thead>
        <tr>
